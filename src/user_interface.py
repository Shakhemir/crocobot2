...
def get_end_game_message(word):
    word_of_gpt = gpt_injection("Напиши мотивационный текст в одном предложении для участия в игре, где нужно объяснить загаданное слово другими словами. Тон должен быть в меру строгим, с тонкой ноткой завуалированного и красивого юмора и с не более 210 символов. В тексте не упоминай, что это виртуальная игра «Крокодил». Упомяни правило: . Ответ должен содержать только готовое предложение.")
    text = (
